                ...
                <th style="padding-right: 23px;">
                    ...
                    <form method="post">
                        ...
                        <div class="box" id="add_dia"
                            ...
                            <button name="patientId" value="${patient.getId()}" onclick="this.form.submit()">Add
                            </button>
                        </div>
                    </form>
                </th>
                <th colspan="3" align="left"><fmt:message key="set.date"/></th>
            </tr>
                    ...
                    <th>
                        ...
                        <form method="post">
                            <div class="box" id="add_app"
                                ...
                                <fmt:message key="label.type"/>: <select name="type">
                                ...
                                <br>
                                <fmt:message key="label.details"/>: <input name="details" type="text"/>
                                <br>
                                <fmt:message key="label.days"/>: <input name="num_days" type="number" min="1"/>
                                <br>
                                <fmt:message key="label.time"/>: <input name="time" type="time"/><img
                                ...
                                <button name="diagnosisId" value="${diagnosis.getId()}" onclick="this.form.submit()"><fmt:message key="label.add"/>
                                </button>
                            </div>
                        </form>
                    </th>
