...
<nav class = "menu">
	...
	<ul>
		...
		<li><a href = "#" class="text"><fmt:message key = "menu.myEvents"/></a>
			<ul>
				<li><a href = "#" class="text"><fmt:message key = "menu.myEvents.procedures"/></a></li>
				<li><a href = "#" class="text"><fmt:message key = "menu.myEvents.operations"/></a></li>
				<li><a href = "#" class="text"><fmt:message key = "menu.myEvents.medicines"/></a></li>
			</ul>
		</li>
		<li><a href = "#" class="text"><fmt:message key = "menu.entrance"/></a>
			<ul>
				<li><a href = "/authorisation" class="text"><div><fmt:message key = "menu.entrance.signIn"/></div></a></li>
				<li><a href = "#" class="text"><div><fmt:message key = "menu.entrance.signUp"/></div></a></li>
			</ul>
		</li>
	</ul>
	<select name="locale">
